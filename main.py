...
async def macd_signal_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    result = await loop.run_in_executor(None, get_macd_signal)
    ...
    try:
        current_price_info = await loop.run_in_executor(None, lambda: client.get_symbol_ticker(symbol=TRADE_SYMBOL))
...
async def get_balance(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    loop = asyncio.get_event_loop()
    try:
        balance_info = await loop.run_in_executor(None, client.get_account)
...
async def get_price(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    loop = asyncio.get_event_loop()
    try:
        price_info = await loop.run_in_executor(None, lambda: client.get_symbol_ticker(symbol=TRADE_SYMBOL))
...
async def buy_btc_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    loop = asyncio.get_event_loop()
    result = await loop.run_in_executor(None, execute_market_trade, "BUY")
...
async def sell_btc_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    loop = asyncio.get_event_loop()
    result = await loop.run_in_executor(None, execute_market_trade, "SELL")
    await update.message.reply_text(result)
...
async def check_macd_and_trade(context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if signal_action == "BUY":
            ...
            trade_message = await loop.run_in_executor(None, execute_market_trade, "BUY")
            ...
            trade_message = await loop.run_in_executor(None, execute_market_trade, "SELL")
